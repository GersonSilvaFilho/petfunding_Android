package com.gersonsilvafilho.library.view.impl
...
import com.gersonsilvafilho.library.R
import com.gersonsilvafilho.library.presenter.BasePresenter
import com.gersonsilvafilho.library.util.ProgressDialogHelper

/**
 * Created by GersonSilva on 4/10/17.
 */
abstract class ViewImpl : com.gersonsilvafilho.library.view.View {
    ...
    fun initSwipeToRefresh(swipeRefreshLayout: SwipeRefreshLayout, presenter: BasePresenter<com.gersonsilvafilho.library.view.View>) {
    ...
    private val snackBarBackground: View?
        get() {
            if (activity != null) {
